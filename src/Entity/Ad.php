...
class Ad
{
     ...
     * @Assert\Length(min=20, minMessage="Votre introduction ne peut pas 
     * faire moins de 20 caractères")
     */
    private $introduction;

    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=100, minMessage="Votre description ne peut pas 
